...
ffs.path.2007=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/Aged07.csv")
ffs.path.2008=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/AGED08.csv")
ffs.path.2009=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/aged09.csv")
ffs.path.2010=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/aged10.csv")
ffs.path.2011=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/aged11.csv")
ffs.path.2012=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/aged12.csv")
ffs.path.2013=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/aged13.csv")
ffs.path.2014=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/aged14.csv")
ffs.path.2015=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/FFS15.xlsx")
ffs.path.2016=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/FFS16.xlsx")
ffs.path.2017=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/FFS17_AdvancedNotice.xlsx")
ffs.path.2018=paste0(ffs.path,"FFS Costs/Extracted Data/Aged Only/FFS18.xlsx")

drops=array(dim=c(12,2))
drops[,1]=c(2007:2018)
drops[,2]=c(5,4,7,7,2,2,2,2,2,2,2,2)
...
for (y in 2015:2018){
  ...
  if (y==2015) {
    ffs.data=read_xlsx(get(paste0("ffs.path.",y)),
                     skip=d,
    ...
    ffs.data <- ffs.data %>% mutate(mean_risk=NA)
  }
...
ffs.costs.final=rbind(ffs.costs.2007, ffs.costs.2008, ffs.costs.2009,
                      ...
                      ffs.costs.2016, ffs.costs.2017, ffs.costs.2018)
