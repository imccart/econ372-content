...
???
We left class on Thursday with this example, so that's where we'll pick back up today. Split into breakout groups and work on this problem together. Hint: To find $u=E[U(w)]$, take the inverse of the natural log, which is $exp^{u}$ in this case.

Regroup after abount 10 minutes to discuss areas of confusion or disagreement.
