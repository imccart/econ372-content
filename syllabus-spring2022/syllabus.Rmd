...
Each of you will analyze data and prepare a report on a practical health economics problem. This semester, the project concerns hospital price transparency and compliance with regulators. Details of the project are available on the [class website](https://econ372s23.classes.ianmccarthyecon.com/), and your final report is due on the last day of class (**April 24, 2023**). 
